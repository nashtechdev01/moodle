...
class workshop_portfolio_caller extends portfolio_module_caller_base {
    ...
    function __construct($callbackargs) {
        ...
        if (!$this->submissionid) {
            throw new portfolio_caller_exception('err_mustprovidesubmission', 'workshop');
        }
    }
    ...
    public function load_data() {
        ...
        if (!$this->submission = $DB->get_record('workshop_submissions', array('id' => $this->submissionid))) {
            throw new portfolio_caller_exception('err_invalidsubmissionid', 'workshop');
        }
        ...
        // @todo depending on whether there are files or not, we might have to change richhtml/plainhtml
    }
    ...
    function get_navigation() {
        // @todo return navigation that logically follows from the place the user was before
    ...
    function check_permissions() {
        // @todo check permission by user id and submission capability
     ...
     */
    function get_sha1(){
        // @todo return sha1 of submissionid and submission content, used to detect duplicated export
        return sha1($this->submissionid);
    }
