...
$string['err_invalidsubmissionid'] = 'Submission id is invalid';
$string['err_invalidcoursemodule'] = 'Course module is invalid';
...
$string['err_mustprovidesubmission'] = 'You must provide submission id to export';
...
$string['exportdiscussion'] = 'Export discussion to portfolio';
$string['exportwholediscussion'] = 'Export whole discussion to portfolio';
...
$string['workshop:exportownsubmissionandassessment'] = 'Export own submission and assessment';
