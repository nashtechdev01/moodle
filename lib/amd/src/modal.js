...
define(['jquery', 'core/templates', 'core/notification', 'core/key_codes',
    ...
    Modal.prototype.show = function() {
        ...
        this.getBackdrop().done(function(backdrop) {
            ...
            // Handle click backdrop to close modal.
            // Disable events click of modal-container to be able to click on backdrop,
            // because modal-container above backdrop and has z-index higher.
            $('[data-region="modal-container"]').css('pointer-events', 'none');
            // Set events click of modal, can click on content of modal.
            $('[data-region="modal"]').css('pointer-events', 'auto');
            // Click on backdrop to close modal.
            $('[data-region="modal-backdrop"]').click(function() {
                this.hide();
            }.bind(this));
